<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuPrincipal.aspx.cs" Inherits="ControlEscuela.MenuPrincipal" %>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <div class="auto-style1">
            <br />
            <br />
            <asp:Image ID="ImgPortada" runat="server" Height="389px" Width="625px" />
        </div>
    </form>
</body>
