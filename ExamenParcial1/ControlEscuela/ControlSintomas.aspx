<%@ Page Async="true" Language="C#" AutoEventWireup="true" CodeBehind="ControlSintomas.aspx.cs" Inherits="ControlEscuela.ControlSintomas" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="container" style="color:white;">
        ...
        <br />
         <div class="auto-style1">
            <h4>Control Sintomas</h4> 
        </div>
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="input-group date">
                    <asp:textbox type="text" ID="txtFecha" placeholder="Fecha" runat="server" class="form-control"></asp:textbox>
                </div>
            </div>
            <div class="col-lg-4 col-md-12">
                <div class="input-group date">
                    <asp:textbox type="text" ID="txtMatricula" placeholder="Matricula" runat="server" class="form-control"></asp:textbox>
                </div>
            </div>
